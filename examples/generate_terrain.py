...
def display_world_statistics(generator, water_mask):
    ...
    print(f"Cell size: {generator.km_per_cell:.2f} km ({generator.area_per_cell_sqmiles:.2f} sq miles)")
    ...
    print(f"Estimated population (at {density_per_sqmile} per sq mile): {est_population:,}")
...
def main():
    ...
    parser.add_argument("--quick", action="store_true", help="Skip intermediate visualizations")
